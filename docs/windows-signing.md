...
状态（2026-09-17）：维护者已同意项目原创代码采用 MIT。尚未向 SignPath 提交申请，尚未取得批准、账户、证书或签名产物。Windows 下载入口保持暂停。
...
| Download URL | https://github.com/systemoutprintlnhelloworld/Modivue/releases （历史预览包；Windows 入口暂停，恢复前需验收） |
...
- 如实说明当前项目规模与 Windows 下载暂停状态。SignPath 要求可核验信誉；MIT 许可证不保证获批。
...
5. 实测 portable、安装版、原生点击与多 DPI，全部验收后再恢复 README 的 Windows 下载入口。
